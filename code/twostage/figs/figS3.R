...
getSampSize <- function(n, q, i0, r0t, r0w, alpha, r0v, phi_trad, sampN, sigma_trad, diff_init_vax_unvax) {
  phi_trans = phi_trad
...
# Panel 2
pan2_xs <- seq(1.1, 3, by=0.1)
pan2res1 <- sapply(pan2_xs, getSampSize, n = n, q = q, i0 = i0, r0t = r0t, sampN = sampN, 
                    alpha = alpha, r0v = 0.9, phi_trad = phi_trad, sigma_trad = sigma_trad, diff_init_vax_unvax = FALSE)
pan2res2 <- sapply(pan2_xs, getSampSize, n = n, q = q, i0 = i0, r0t = r0t, sampN = sampN, 
                   alpha = alpha, r0v = 1.1, phi_trad = phi_trad, sigma_trad = sigma_trad, diff_init_vax_unvax = FALSE)

# Panel 3
pan3_xs <- seq(0, 0.6, 0.1)
pan3res1 <- sapply(pan3_xs, getSampSize, n = n, q = q, i0 = i0, r0t = r0t,
                   r0w = r0w, alpha = alpha, r0v = 0.9, sampN = sampN, sigma_trad = sigma_trad, diff_init_vax_unvax = FALSE)
pan3res2 <- sapply(pan3_xs, getSampSize, n = n, q = q, i0 = i0, r0t = r0t,
                   r0w = r0w, alpha = alpha, r0v = 1.1, sampN = sampN, sigma_trad = sigma_trad, diff_init_vax_unvax = FALSE)

# Plot fig
png(file="~/netVax/code_output/figs/figS3.png",
    width=6.5, height=3.75, units="in", res=400)
par(mfrow = c(1, 2))
plot(pan2_xs, pan2res1, type='l', 
     ylab='Required number of clusters',
     xlab=expression('R'['0,w']),
     col='blue', lwd=3, ylim=c(0, max(pan2res1, pan2res2)), cex.lab=1.25)
...
plot(pan3_xs, pan3res1, type='l', 
     ...
     col='blue', lwd=3, cex.lab=1.5, ylim=c(0, max(pan3res1, pan3res2)))
